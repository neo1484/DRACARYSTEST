...
public class PreventaProductoDist 
{
	private int _id;
	private int _preventaProductoId;
	...
	public PreventaProductoDist(){}

	public PreventaProductoDist(int _id, int _preventaProductoId,
			int _preventaId, int _productoId, int _promocionId, int _cantidad,
			int _cantidadPaquete, float _monto, float _descuento,
			float _montoFinal, int _estadoId, boolean _estadoSincronizacion,
			float _costo,int _costoId,int _precioId, float _descuentoCanal,
			float _descuentoAjuste, int _canalPrecioRutaId, float _descuentoProntoPago) 
	{
		super();
		this._id = _id;
		this._preventaProductoId = _preventaProductoId;
	...
	public int get_preventaProductoId() {
		return _preventaProductoId;
	}

	public void set_preventaProductoId(int _preventaProductoId) {
		this._preventaProductoId = _preventaProductoId;
	}
