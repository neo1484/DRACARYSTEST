...
public class Preventa 
{
	...
	public Preventa(int _Id, int _preventaIdServer, int _empleadoId, int _clienteId,
			float _monto, float _descuento, float _montoFinal, int _tipoPagoId,
			double _latitud, double _longitud, boolean _estado,int _dia, int _mes,
			int _anio, int _hora, int _minuto, String _factura, String _nit,
			boolean _nitNuevo, int _noPreventa, String _observacion, boolean _aplicarBonificacion,
			int _diaEntrega, int _mesEntrega, int _anioEntrega, int _dosificacionId, String _tipoNit,
			String _ruta, String _tipoVisita, int _zonaVentaId, int _prontoPagoId, float _descuentoCanal,
			float _descuentoAjuste, float _descuentoProntoPago, float _descuentoObjetivo, int _formaPagoId,
			String _codTransferencia, boolean _fromApk, boolean _fromShopp, float _descuentoIncentivo)
	{
		super();
		this._Id = _Id;
